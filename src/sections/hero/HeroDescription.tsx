...
export function HeroDescription({ className = '' }: HeroDescriptionProps) {
  return (
    <WhitePanelBottomRight className={`lg:max-w-[min(520px,44%)] ${className}`.trim()}>
      <p className="font-satoshi text-[18px] font-normal leading-[1.5] tracking-normal text-neutral-800 sm:text-[20px] lg:px-12 lg:py-12 lg:pt-12 lg:pr-12 lg:pb-12 lg:pl-12 lg:text-[20px] lg:leading-[1.6]">

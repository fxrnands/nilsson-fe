  ...
  return (
    <section className="w-full shrink-0 lg:w-auto" aria-labelledby="services-heading">
      <article className="relative aspect-[3/2] w-full max-h-[min(52svh,440px)] overflow-hidden rounded-2xl sm:max-h-[min(56svh,480px)] lg:aspect-auto lg:size-services-card lg:max-h-none lg:shrink-0 lg:rounded-tl-card lg:rounded-tr-none lg:rounded-br-card lg:rounded-bl-card">
        ...
        <p
          id="services-heading"
          className="pointer-events-none absolute top-3 left-3 z-10 font-general text-services-mobile leading-none font-normal tracking-normal text-white capitalize sm:top-8 sm:left-8 sm:text-services-sm lg:top-auto lg:bottom-[5%] lg:left-[8%] lg:text-services-desktop lg:uppercase lg:whitespace-nowrap"
        >
          Services
        </p>
      </article>
      ...
      <div className="mt-8 lg:hidden">
        <h3 className="font-general text-title-md font-medium leading-[1.2] text-neutral-950">
          Architecture
        </h3>
        <p className="mt-2 font-satoshi text-body-sm font-normal leading-normal text-neutral-800">

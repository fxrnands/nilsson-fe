  ...
  return (
    <aside className="flex w-full shrink-0 flex-col lg:h-services-card lg:w-news-intro lg:min-w-news-intro lg:max-w-news-intro lg:justify-between lg:px-selected-work-x">
      <div className="flex flex-col items-start gap-6 lg:hidden">
        <h2 className="font-general text-news-section-mobile font-normal leading-none tracking-normal text-ink uppercase sm:text-display-sm">
          News
        </h2>
        <p className="font-satoshi text-body font-normal leading-[1.5] tracking-normal text-ink">
          {introCopy}
        </p>
      ...
      <div className="hidden flex-col items-start lg:flex lg:h-full lg:justify-between">
        <div className="flex flex-col items-start">
          <p className="font-satoshi text-body-lg font-normal leading-[1.5] tracking-normal text-ink">
            {introCopy}
          </p>
        ...
        <h2 className="font-general text-news-section-desktop font-normal leading-none tracking-normal text-ink uppercase">
          News
        </h2>
      </div>
    </aside>
